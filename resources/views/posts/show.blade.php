    ...
    <div class="container">
        <div class="container" style="text-align: center; margin-top: 10px">
            ...
            <div class="card" style="border: lightgrey 1px solid; background: whitesmoke; border-radius: 20px; box-shadow: 8px 8px 5px grey;">
                ...
                {{-- Tags --}}
            @if(count($post->tags))
                <div class="d-flex flex-row" style="margin-top: 10px; width: 150px">
                    @foreach($post->tags as $tag)
                            <a href="/posts/tags/{{ $tag->id }}" class="list-group-item list-group-item-action list-group-item-success" style="margin-left: 5px">
                                {{ $tag->name }}</a>
                    @endforeach
                </div>
            @endif
